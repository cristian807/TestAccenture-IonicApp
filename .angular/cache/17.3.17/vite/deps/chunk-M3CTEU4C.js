...
var _AST_static;
var parseAST_fn;
var partsToRegExp_fn;
var parseGlob_fn;
var _AST = class _AST2 {
  ...
  push(...parts) {
    for (const p of parts) {
      if (p === "")
        continue;
      if (typeof p !== "string" && !(p instanceof _AST2 && __privateGet(p, _parent) === this)) {
  ...
  isStart() {
    ...
    for (let i2 = 0; i2 < __privateGet(this, _parentIndex); i2++) {
      ...
      if (!(pp instanceof _AST2 && pp.type === "!")) {
        return false;
      }
    }
    return true;
  ...
  clone(parent) {
    const c = new _AST2(this.type, parent);
    for (const p of __privateGet(this, _parts)) {
      c.copyIn(p);
    }
    return c;
  ...
  static fromGlob(pattern, options = {}) {
    var _a;
    const ast = new _AST2(null, void 0, options);
    __privateMethod(_a = _AST2, _AST_static, parseAST_fn).call(_a, pattern, ast, 0, options);
    return ast;
  }
  ...
  toRegExpSource(allowDot) {
    ...
    if (!this.type) {
      ...
      const src = __privateGet(this, _parts).map((p) => {
        var _a2;
        const [re, _, hasMagic, uflag] = typeof p === "string" ? __privateMethod(_a2 = _AST2, _AST_static, parseGlob_fn).call(_a2, p, __privateGet(this, _hasMagic), noEmpty) : p.toRegExpSource(allowDot);
...
render() {
  ...
  if (BUILD.experimentalScopedSlotChanges && cmpMeta.$flags$ & 2) {
    ...
    for (const childNode of children) {
      if (childNode["s-hn"] !== hostTagName && !childNode["s-sh"] && childNode.nodeType === 1) {
...
@stencil/core/internal/client/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-M3CTEU4C.js.map
